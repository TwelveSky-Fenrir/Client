...
enum class Incoming : uint8_t {
    ...
    GroundItemRemove           = 0x19, // Pkt_GroundItemRemove 0x46a200 // ex-VeryOldClient: USE_HOTKEY_ITEM_RECV (PLAUSIBLE)
    ...
    OnGuildNoticeChat          = 0x54, // Net_OnGuildNoticeChat 0x492f40 // ex-VeryOldClient: TRIBE_NOTICE_RECV (PLAUSIBLE)
...
enum class Outgoing : uint8_t {
    Op12  = 0x0c, // login / enter-world / char-create (composite 128+13+72 o) // ex-VeryOldClient: CZ_REGISTER_AVATAR_SEND (PLAUSIBLE)
    ...
    Op80  = 0x50, // record 61 o // ex-VeryOldClient: GENERAL_CHAT_SEND (PLAUSIBLE)
    Op81  = 0x51, // record 61 o // ex-VeryOldClient: GENERAL_CHAT_SEND (PLAUSIBLE)
    ...
    Op92  = 0x5c, // commande a 1 octet // ex-VeryOldClient: MAKE_SKILL_SEND (PLAUSIBLE)
    ...
    Op96  = 0x60, // 3 octets
    Op97  = 0x61, // commande a 1 octet // ex-VeryOldClient: CHANGE_TO_TRIBE4_SEND (PLAUSIBLE)
    Op98  = 0x62, // action a 3 octets // ex-VeryOldClient: SOCKET_SYSTEM_SEND (PLAUSIBLE)
    ...
    Op104 = 0x68, // action a 2 octets // ex-VeryOldClient: PROCESS_ATTACK_SEND (PLAUSIBLE)
    Op105 = 0x69, // opcode seul (ping)
    Op106 = 0x6a, // 1 octet + struct 12 o
    Op107 = 0x6b, // 1 octet + struct 13 o // ex-VeryOldClient: FAIL_MOVE_ZONE_2_SEND (PLAUSIBLE)
    ...
    Op118 = 0x76, // opcode seul (ping) // ex-VeryOldClient: HERORANK_INFO_SEND (PLAUSIBLE)
    Op119 = 0x77, // opcode seul (ping) // ex-VeryOldClient: HERORANK_INFO_SEND (PLAUSIBLE)
    ...
    Op132 = 0x84, // commande a 4 octets // ex-VeryOldClient: MAKE_ITEM_SEND (PLAUSIBLE)
    ...
    Op137 = 0x89, // commande a 4 octets // ex-VeryOldClient: MAKE_ITEM_SEND (PLAUSIBLE)
    Op138 = 0x8a, // commande a 13 octets // ex-VeryOldClient: MAKE_ITEM_SEND (PLAUSIBLE)
    Op139 = 0x8b, // commande a 1 octet
    Op140 = 0x8c, // opcode seul // ex-VeryOldClient: TRADE_MENU_SEND (PLAUSIBLE)
